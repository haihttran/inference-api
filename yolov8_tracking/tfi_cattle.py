...
def run(
    ...
    if animal_type == "sheep1080":
        rect = (700, 135, 450, 824)  # fletchers 1080 (687,135,571,824) 720 (610, 56, 150, 600)   #coggan (1024, 206, 136, 332)
    elif animal_type == "sheep540":
        rect = (150, 0, 360, 540)
            ...
            if det is not None and len(det):
                ...
                if len(outputs[i]) > 0:
                    ...
                    for j, (output) in enumerate(outputs[i]):
                        ...
                        if cls in [0,1] and id not in dict_initial_animal_xyxy :
                        ...
                        if cls in [0,1]  and det_width < 200 and det_height < 200:
                            ...
                            if temp > 0.5 and dict_initial_animal_xyxy[id][2] - counting_rect[0] < 0 and dict_initial_animal_twenty_in_xyxy[id][0] - counting_rect[0] < 50 :
                                    animal_counter[id] += 1
                                    add_animal_to_indi_count(id, dict_animal_indi_count, animal_counter)

                                # animal going left
                            elif temp > 0.9 and dict_initial_animal_xyxy[id][2] - counting_rect[2] > 100 and dict_initial_animal_twenty_in_xyxy[id][2] - counting_rect[2] > 0:
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=Path, default= '/home/rama/Documents/code-repo/github/yolov8_tracking/weights/yolo/yolov8l-goats.pt', help='model.pt path(s)')
    parser.add_argument('--reid-weights', type=Path, default=WEIGHTS / 'osnet_x1_0_imagenet.pt')
